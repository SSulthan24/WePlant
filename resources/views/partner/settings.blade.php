...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 text-white animate-fade-in">
            ...
            <p class="text-green-50">Kelola informasi profil dan keamanan akun mitra</p>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg p-6 animate-fade-in">
                    ...
                    <form action="{{ route('partner.settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white rounded-2xl shadow-lg p-6 animate-fade-in">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="font-semibold text-green-900">Mitra</p>
                        </div>
                        <div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 animate-fade-in">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <form action="{{ route('partner.settings.update') }}" method="POST" enctype="multipart/form-data" class="w-full">
                            @csrf
