...
@section('title', 'Pengaturan | WePlan(t)')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 text-white animate-fade-in">
            ...
            <p class="text-green-50">Kelola informasi profil dan keamanan akun admin</p>
        </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white rounded-2xl shadow-lg p-6 animate-fade-in">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="font-semibold text-green-900">Admin</p>
                        </div>
                        <div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 animate-fade-in">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data" class="w-full" id="avatarForm">
                            @csrf
